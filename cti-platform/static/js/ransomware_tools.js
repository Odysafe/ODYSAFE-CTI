...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function handleDownload() {
        ...
        if (!confirm('Download Ransomware Tool Matrix from GitHub?\n\nAn internet connection is required.')) {
            return;
        }
        ...
        try {
            await postDownloadWithProgress(
                '/api/ransomware-tools/download',
                'Downloading Ransomware Tool Matrix from GitHub...',
                'Download completed!'
            );
            showNotification('Repository downloaded successfully! Reloading page...', 'success');
    ...
    async function handleRefresh() {
        // Inform user that internet connection is required
        if (!confirm('Update Ransomware Tool Matrix from GitHub?\n\nAn internet connection is required.')) {
            return;
        }
        ...
        try {
            await postActionWithProgress(
                '/api/ransomware-tools/update',
                'Updating repository…',
                'Update complete'
            );
