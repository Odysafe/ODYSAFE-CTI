...
if SECRET_KEY is None:
    ...
    # Note: In production, set CTI_SECRET_KEY environment variable
...
# ZettelForge local CTI memory (vector + graph, no LLM)
ZETTELFORGE_MEMORY_DIR = BASE_DIR / "data" / "zettelforge"
ZETTELFORGE_MEMORY_MAX_TEXT = int(os.getenv('ZETTELFORGE_MEMORY_MAX_TEXT', '80000'))
...
PREDEFINED_TAGS = [
    ...
    {"name": "Under Review", "category": "status", "color": "#F59E0B", "auto": False},
]
