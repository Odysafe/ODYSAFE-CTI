...
def handle_api_errors(route_name: str = None):
    """
    Décorateur pour gérer automatiquement les erreurs dans les routes API.
    Log les erreurs et retourne une réponse API standardisée.
    ...
    Args:
        route_name: Nom de la route pour le logging (optionnel, utilise le nom de la fonction si non fourni)
    """
