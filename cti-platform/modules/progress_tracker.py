...
class ProgressTracker:
    ...
    def complete_task(self, task_id: str, message: str = "Completed",
        ...
        with self._lock:
            ...
            self._progress[task_id].update(final_state)
    ...
    def stopped_task(self, task_id: str, message: str = "Stopped by user"):
        """Marks a task as stopped after the worker acknowledges cancellation."""
        with self._lock:
            if task_id not in self._progress:
                return
