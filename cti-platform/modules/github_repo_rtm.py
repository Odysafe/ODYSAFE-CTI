    ...
    def download_repo(self) -> bool:
        ...
        try:
            ...
            with download_lock("rtm", timeout=300):
                ...
                logger.info(f"Cloning pinned Ransomware Tool Matrix snapshot to {temp_clone_dir}...")
                if not clone_pinned_repo("ransomware_tool_matrix", temp_clone_dir, timeout=120):
                    return False
